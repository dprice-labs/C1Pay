...
- 2026-06-22: Addressed code review findings — balance validation, falsy-zero env parsing, production-safe connection close, partial-batch summary reporting, symlink-safe CLI guard, and redundant-hash avoidance on idempotent re-runs.
